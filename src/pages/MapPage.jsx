...
export default function MapPage() {
    ...
    const resolvedImageUrl = resolveMapImage(currentMapConfig.imageSlug)
        ...
        <div className="h-full w-full relative bg-[#0a0a0a] overflow-hidden z-0">
            ...
            {resolvedImageUrl ? (
                ...
                <div className="flex flex-col h-full w-full items-center justify-center text-gray-500 font-mono text-sm uppercase">
                    ...
                    <span>[ERROR] Image introuvable pour "{currentMapConfig.imageSlug}" (vérifie l'extension et le slug)</span>
                </div>
            )}
